...
#ifndef ART_RUNTIME_GC_COLLECTOR_MARK_REPLICATE_H_
#define ART_RUNTIME_GC_COLLECTOR_MARK_REPLICATE_H_
...
class MarkReplicate : public GarbageCollector {
 public:
  explicit MarkReplicate(Heap* heap);
 ...
 private:
  ...
  friend class MarkReplicateMarkObjectSlowPath;

  DISALLOW_COPY_AND_ASSIGN(MarkReplicate);
};
...
#endif  // ART_RUNTIME_GC_COLLECTOR_MARK_REPLICATE_H_
