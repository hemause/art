...
#include "gc/collector/mark_replicate.h"
...
Heap::Heap(size_t initial_size, size_t growth_limit, size_t min_free, size_t max_free,
  ...
  */
  ...
  if (kMovingCollector) {
    ...
    mark_replicate_collector_ = new collector::MarkReplicate(this);
    garbage_collectors_.push_back(mark_replicate_collector_);
  }
  ...
  if (compacting_gc) {
    ...
    switch (collector_type_) {
      ...
      case kCollectorTypeMC:
        ...
        break;
      case kCollectorTypeMR:
	collector = mark_replicate_collector_;
	break;
      default:
